...
describe('NoEntitiesMessage Unit tests - ', () => {
  ...
  it('Should show appropriate default message', () => {
    ...
    expect(noEntitiesMessage.find('.empty-message-container .action-item').length).toBe(1);
    noEntitiesMessage.unmount();
  });
  ...
  it('Should show appropriate message when filters are applied', () => {
    ...
    expect(noEntitiesMessage.find('.empty-message-container .action-item').length).toBe(2);
    noEntitiesMessage.unmount();
  });
  ...
  it('Should open up the Add Entity modal when "Add" is clicked', () => {
    ...
    let addButtonContainer = noEntitiesMessage.find('.empty-message-container .add-entity');
